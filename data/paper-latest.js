window.ASTROBRIEF_PAPER = {
  "status": "snapshot",
  "generatedAt": "2026-05-04T01:50:24.9030301Z",
  "snapshotDateKst": "2026-05-04",
  "snapshotLabel": "2026년 5월 4일 오전 9시 KST 스냅샷",
  "publishedAt": "2026-05-01T17:58:37.0000000+00:00",
  "updatedAt": "2026-05-01T17:58:37.0000000+00:00",
  ...
  "title": "PEARLS: Two Distinct Populations of AGN Hosts Moving Between Star Formation and Quiescence",
  "authors": [
    "Gibson B. Bowling",
    "Rafael Ortiz",
    "S. P. Willner",
  ...
  "arxivUrl": "https://arxiv.org/abs/2605.00822v1",
  "summaryBullets": [
    "이 논문은 'PEARLS: Two Distinct Populations of AGN Hosts Moving Between Star Formation and Quiescence'라는 질문을 중심으로 은하와 은하 주변 물질의 진화 문제를 다룹니다. 초록의 첫 메시지는 'We present the results of AGN--host-galaxy decomposition using JWST/NIRCam, HST/ACS, and HST/WFC3 imaging of the North Ecliptic Pole Time Domain Field (NEP-TDF).'에 가깝습니다.",
    "접근 방식은 초록에 제시된 핵심 가설을 검증하기 위한 분석적 접근에 가깝고, 저자들은 어떤 파라미터나 관측량이 결론을 가장 크게 움직이는지에 주목합니다.",
    "초록의 마무리 메시지는 'Both groups show evidence of recent transition between star formation and quiescence, but neither group shows preference for higher or lower stellar mass or redshift, suggesting that star formation in NIRCam-selected AGN-hosts is more strongly determined by AGN activity than by stellar mass.'으로 읽을 수 있어서, 후속 연구에서는 이 결론이 다른 데이터셋과 가정에서도 유지되는지 확인하는 것이 중요합니다."
  ],
  "takeaways": [
