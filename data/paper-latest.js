window.ASTROBRIEF_PAPER = {
  "status": "snapshot",
  "generatedAt": "2026-04-07T01:20:19.8486586Z",
  "snapshotDateKst": "2026-04-07",
  "snapshotLabel": "2026년 4월 7일 오전 9시 KST 스냅샷",
  "publishedAt": "2026-04-03T17:59:50.0000000+00:00",
  "updatedAt": "2026-04-03T17:59:50.0000000+00:00",
  ...
  "arxivUrl": "https://arxiv.org/abs/2604.03230v1",
  "summaryBullets": [
    "이 논문은 'Stars Born in the Wind II: Widespread Extra-planar Star Formation in M82's Halo'라는 질문을 중심으로 은하와 은하 주변 물질의 진화 문제를 다룹니다. 초록의 첫 메시지는 'Galaxies evolve in tandem with their environments -- mergers and gas inflows drive galaxy growth while galactic outflows launched by supernovae may seed the galactic environment with gas, metals, and energy, fueling star-formation far from the main bodies of galaxies.'에 가깝습니다.",
    "접근 방식은 관측 자료와 서베이 데이터를 활용한 접근에 가깝고, 저자들은 어떤 파라미터나 관측량이 결론을 가장 크게 움직이는지에 주목합니다.",
    "초록의 마무리 메시지는 'We forward a picture where the M82 Tail formed from ram pressure stripped gas arising from M82's westward motion, triggered by shocks from the outflow.'으로 읽을 수 있어서, 후속 연구에서는 이 결론이 다른 데이터셋과 가정에서도 유지되는지 확인하는 것이 중요합니다."
  ],
  "takeaways": [
